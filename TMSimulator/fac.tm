...
* -> id
* looking up id: fac
 22:    LDA  0,-3(5) 	load id address, load the address of fac into reg[0]
* <- id
 23:     ST  0,-4(5) 	op: push left, store reg[0](address of fac?) in dMem[next spot]
* -> constant
 24:    LDC  0,1(0) 	load const, load the num into reg[0]
* <- constant
